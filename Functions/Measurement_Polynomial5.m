...
if model == "Full5"
    ...
    elseif n_coe == 0
        p_coordinate = [1, 1, 1, 0.5, 1, 0.5, 1/6, 0.5, 0.5, 1/6, 1/24, 1/6, 1/4, 1/6, 1/24, 1/120, 1/24, 1/12, 1/12, 1/24, 1/120]';
    else
...
Hx = [repelem(1, n_point); chi; xi; 
      ...
      chi.^5; chi.^4 .* xi; chi.^3 .* xi.^2; chi2 .* xi.^3; chi .* xi.^4; xi.*5]';     
